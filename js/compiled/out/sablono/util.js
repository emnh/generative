...
var x__20911__auto__ = (((x == null))?null:x);
var m__20912__auto__ = (sablono.util.to_str[goog.typeOf(x__20911__auto__)]);
if(!((m__20912__auto__ == null))){
return m__20912__auto__.call(null,x);
} else {
var m__20912__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__20912__auto____$1 == null))){
return m__20912__auto____$1.call(null,x);
} else {
...
var x__20911__auto__ = (((x == null))?null:x);
var m__20912__auto__ = (sablono.util.to_uri[goog.typeOf(x__20911__auto__)]);
if(!((m__20912__auto__ == null))){
return m__20912__auto__.call(null,x);
} else {
var m__20912__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__20912__auto____$1 == null))){
return m__20912__auto____$1.call(null,x);
} else {
...
var len__21323__auto___21550 = arguments.length;
var i__21324__auto___21551 = (0);
while(true){
if((i__21324__auto___21551 < len__21323__auto___21550)){
args__21330__auto__.push((arguments[i__21324__auto___21551]));

var G__21552 = (i__21324__auto___21551 + (1));
i__21324__auto___21551 = G__21552;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__21331__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq21549){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21549));
});
...
var vec__21556 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
...
var first_word = first__21558;
var words = seq__21557__$1;
...
var G__21560 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__21560,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__21560;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__21561_SHARP_){
if(typeof p1__21561_SHARP_ === 'string'){
return p1__21561_SHARP_;
} else {
return cljs.core.seq.call(null,p1__21561_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__20248__auto__ = x__$1.hasDomain();
