...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__21564_SHARP_){
return ((p1__21564_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__21564_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__21566,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__21566;
}
});
...
var len__21323__auto___21569 = arguments.length;
var i__21324__auto___21570 = (0);
while(true){
if((i__21324__auto___21570 < len__21323__auto___21569)){
args__21330__auto__.push((arguments[i__21324__auto___21570]));

var G__21571 = (i__21324__auto___21570 + (1));
i__21324__auto___21570 = G__21571;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__21331__auto__);
});
...
var G__21568 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21568,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__21568;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq21567){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21567));
});
...
var vec__21577 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__21577,(0),null);
var names = cljs.core.nth.call(null,vec__21577,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__21577,tag_name,names){
return (function (p1__21572_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__21572_SHARP_));
});})(matches,vec__21577,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__21577,tag_name,names){
return (function (p1__21573_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__21573_SHARP_));
});})(matches,vec__21577,tag_name,names))
,names)))], null);
});
/**
...
return cljs.core.remove.call(null,cljs.core.nil_QMARK_,((typeof x === 'string')?(function (){var x__21082__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__21082__auto__);
})():(cljs.core.truth_(sablono.util.element_QMARK_.call(null,x))?(function (){var x__21082__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__21082__auto__);
})():(((cljs.core.list_QMARK_.call(null,x)) && ((x instanceof cljs.core.Symbol)))?(function (){var x__21082__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__21082__auto__);
})():((cljs.core.list_QMARK_.call(null,x))?x:(((cljs.core.sequential_QMARK_.call(null,x)) && (cljs.core.sequential_QMARK_.call(null,cljs.core.first.call(null,x))) && (!(typeof cljs.core.first.call(null,x) === 'string')) && (cljs.core.not.call(null,sablono.util.element_QMARK_.call(null,cljs.core.first.call(null,x)))) && (cljs.core._EQ_.call(null,cljs.core.count.call(null,x),(1))))?sablono$normalize$children.call(null,cljs.core.first.call(null,x)):((cljs.core.sequential_QMARK_.call(null,x))?x:(function (){var x__21082__auto__ = x;
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__21082__auto__);
})()
)))))));
});
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__21580){
var vec__21587 = p__21580;
var seq__21588 = cljs.core.seq.call(null,vec__21587);
var first__21589 = cljs.core.first.call(null,seq__21588);
var seq__21588__$1 = cljs.core.next.call(null,seq__21588);
var tag = first__21589;
var content = seq__21588__$1;
...
var vec__21590 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21590,(0),null);
var id = cljs.core.nth.call(null,vec__21590,(1),null);
var class$ = cljs.core.nth.call(null,vec__21590,(2),null);
